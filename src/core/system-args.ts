...
export const systemArgs = {
  ...
  token: {
    describe:
      'Provide your personal access token. Or use AGILITY_TOKEN from .env file if available.',
    demandOption: false,
  ...
  publish: {
    describe:
      'For sync commands only: automatically publish synced content items and pages after successful sync operation. Enables batch publishing for streamlined deployment workflow. Default: false.',
    type: 'boolean' as const,
