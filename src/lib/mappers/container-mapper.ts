...
export class ContainerMapper {
  ...
  addMapping(sourceContainer: mgmtApi.Container, targetContainer: mgmtApi.Container) {
    ...
    if (targetMapping && sourceMapping && targetMapping !== sourceMapping) {
      throw new Error(
        `Invalid Mappings detected! Source contentViewID: ${sourceContainer.contentViewID}, Target contentViewID: ${targetContainer.contentViewID}`
      );
    }
  ...
  updateMapping(sourceContainer: mgmtApi.Container, targetContainer: mgmtApi.Container, mapping: ContainerMapping) {
    if (targetContainer.contentViewID !== mapping.targetContentViewID) {
      throw new Error(
        `Invalid items trying to be mapped! Source contentViewID: ${sourceContainer.contentViewID}, Target contentViewID: ${targetContainer.contentViewID}`
      );
    }
