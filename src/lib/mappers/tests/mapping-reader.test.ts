...
import { readMappingsForGuidPair, listAvailableMappingPairs, getMappingSummary } from "lib/mappers/mapping-reader";
    ...
    const pageMappings = [
      {
        ...
        sourceVersionID: 1,
        targetVersionID: 1,
        sourcePageTemplateName: "T",
        targetPageTemplateName: "T",
      },
    ];
