...
import { HierarchicalPageGroup, SourceEntities, AssetReference } from './types';
...
export class PageChainDisplay {
    ...
    constructor(rootPath: string, sourceGuid: string, locale: string, isPreview: boolean, debug: boolean = false) {
