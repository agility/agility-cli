...
describe("filterPublishedContent", () => {
  ...
  it("stops checking locales after the first one that has the item", () => {
    const readJsonFileMock = jest
      .spyOn(fileOperations.prototype, "readJsonFile")
...
describe("checkSourcePublishStatus", () => {
  ...
  it("combines content and page results into a single PublishStatusResult", () => {
    ...
    const result = checkSourcePublishStatus([makeContentMapping(1, 10)], [makePageMapping(2, 20)], "src", ["en-us"]);
  ...
  it("deduplicates publishedContentIds", () => {
    ...
    const result = checkSourcePublishStatus([makeContentMapping(1, 10), makeContentMapping(1, 10)], [], "src", [
      "en-us",
    ]);
  ...
  it("deduplicates publishedPageIds", () => {
    ...
    const result = checkSourcePublishStatus([], [makePageMapping(2, 20), makePageMapping(2, 20)], "src", ["en-us"]);
